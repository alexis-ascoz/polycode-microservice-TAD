...
<<<
:imagesdir: questions/04 - Tracing
include::questions/04 - Tracing/index.adoc[]
...
include::questions/04 - Tracing/glossary.adoc[]
...
include::questions/04 - Tracing/bibliography.adoc[]
