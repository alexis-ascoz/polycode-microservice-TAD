...
image::images/PolyCode authentication architecture schema.png[]
...
image::images/PolyCode authentication deployment schema.png[]
...
image::images/PolyCode authentication sequence diagram - Vanilla user account creation.png[]

===== User account creation via polytech LDAP

Here is the sequence diagram of the user account creation via polytech LDAP :

.PolyCode authentication sequence diagram - User account creation via polytech LDAP
image::images/PolyCode authentication sequence diagram - User account creation via polytech LDAP.png[]
...
image::images/PolyCode authentication sequence diagram - Google identity provider user account creation.png[]
...
image::images/PolyCode authentication sequence diagram - Vanilla user authentication.png[]
...
image::images/PolyCode authentication sequence diagram - Polytech LDAP user authentication.png[]

===== User authentication via google

Here is the sequence diagram of the user authentication via google :

.PolyCode authentication sequence diagram - User authentication via google
image::images/PolyCode authentication sequence diagram - User authentication via google.png[]
