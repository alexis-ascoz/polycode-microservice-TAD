...
image::images/PolyCode authentication sequence diagram - Polytech LDAP account creation.png[]
...
image::images/PolyCode authentication sequence diagram - Google identity provider user authentication.png[]
