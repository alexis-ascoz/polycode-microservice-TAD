...
image::images/Sidecar pattern - request to microservice.png[]
...
image::images/Service discovery with Consul.png[]
...
image::images/Service discovery with Consul in a kubernetes cluster.png[]
...
image::images/Gossip protocol with consul.png[]
...
image::images/Mailer microservice communication.png[]
...
image::images/PolyCode service discovery with Consul.png[]
