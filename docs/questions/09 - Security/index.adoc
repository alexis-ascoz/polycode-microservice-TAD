...
Let's see what we can do to manage correctly the data.
...
An important part of data management is to backup the data. As said before, the data is the most important asset of a company, and it is necessary to ensure that it is not lost. That's why it is necessary to have copies of the data.

// TODO : read data backup article

=== Secrets Management

=== PolyCode Integration

Sequence diagram of request with consul tls and oauth2 authentication & authorization
